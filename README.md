...
- `MODEL_CHAIN`: comma-separated model chain (default: `gpt-5.2,gemini-3-flash,auto`; when set, retries move to next model)
...
- `BLOCKER_MODE`: blocker handling mode (`stop|skip|retry`, default: `skip`)
